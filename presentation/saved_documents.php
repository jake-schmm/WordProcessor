...
<head>
   ...
   <style>
    ...
    .deleteButton {
        background-color: #0B0C10; /* Modern red for the delete button */
        color: white;
    }
   </style>
    ...
    <div class="container">
        ...
        <form action="saved_documents.php" method="post">
            ...
            <div class="filter-form-elements">
                ...
                <button type="submit" name="submit" value="filter" class = "btn openButton">Search</button>
            </div>
        </form>
        <br/>
        ...
        <?php 
            ...
            foreach ($docArray as $doc) {
                ...
                echo '<div class="button-container"><button type="submit" name="submit" value="open" class="btn openButton"><span class="glyphicon glyphicon-open" aria-hidden="true"> OPEN</button>
                    <button type="button" data-toggle="modal" data-target="#deleteModal-' . $doc->getId() . '"class="btn deleteButton"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> DELETE</button>
                    </div> ';
                echo '</form>';
                echo '</div>';
                ?>
